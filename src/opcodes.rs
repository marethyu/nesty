// Stolen and modified from https://github.com/bugzmanov/nes_ebook/

use std::collections::HashMap;

use crate::m6502::AddressingMode;
...
lazy_static! {
    pub static ref CPU_OPS_CODES: Vec<OpCode> = vec![
        ...
        OpCode::new(0x4c, "JMP", 3, 3, AddressingMode::Immediate), //AddressingMode that acts as Immediate
