...
export class Nesty {
    ...
    static __wrap(ptr) {
        const obj = Object.create(Nesty.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_nesty_free(ptr);
    }
    /**
    * @returns {Nesty}
    */
    static new() {
        const ret = wasm.nesty_new();
        return Nesty.__wrap(ret);
    }
    /**
    * @param {Uint8Array} rom_data
    */
    load_rom(rom_data) {
        wasm.nesty_load_rom(this.ptr, addHeapObject(rom_data));
    }
    /**
    */
    reset() {
        wasm.nesty_reset(this.ptr);
    }
    /**
    */
    update() {
        wasm.nesty_update(this.ptr);
    }
    /**
    * @returns {Uint8Array}
    */
    pixel_buffer() {
        const ret = wasm.nesty_pixel_buffer(this.ptr);
    ...
    */
    press_key(key) {
        wasm.nesty_press_key(this.ptr, key);
    }
    /**
    * @param {number} key
    */
    release_key(key) {
        wasm.nesty_release_key(this.ptr, key);
    }
}
