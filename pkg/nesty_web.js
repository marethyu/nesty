...
export class NestyWeb {
    ...
    static __wrap(ptr) {
        const obj = Object.create(NestyWeb.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_nestyweb_free(ptr);
    }
    /**
    * @returns {NestyWeb}
    */
    static new() {
        const ret = wasm.nestyweb_new();
        return NestyWeb.__wrap(ret);
    }
    /**
    ...
    */
    reset() {
        wasm.nestyweb_reset(this.ptr);
    }
    /**
    */
    save_state() {
        wasm.nestyweb_save_state(this.ptr);
    }
    /**
    */
    load_state() {
        wasm.nestyweb_load_state(this.ptr);
    }
    /**
    */
    update() {
        wasm.nestyweb_update(this.ptr);
    }
    /**
    * @param {number} keycode
    */
    press_key(keycode) {
        wasm.nestyweb_press_key(this.ptr, keycode);
    }
    /**
    * @param {number} keycode
    */
    release_key(keycode) {
        wasm.nestyweb_release_key(this.ptr, keycode);
    }
}
...
function getImports() {
    ...
    imports.wbg.__wbg_drawImage_fb43740dbd3ab8ac = function() { return handleError(function (arg0, arg1, arg2, arg3, arg4, arg5) {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('nesty_web_bg.wasm', import.meta.url);
    }
    const imports = getImports();
